...
#ENV REPO https://github.com/sibbi77/PartKeepr.git
#ENV REPO https://github.com/christianlupus/PartKeepr.git
...
#RUN curl -sS https://getcomposer.org/installer | php -- --filename=composer --install-dir=$HOME/bin
